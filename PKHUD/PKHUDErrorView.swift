...
open class PKHUDErrorView: PKHUDSquareBaseView, PKHUDAnimating {
    ...
    func rotationAnimation(_ angle: CGFloat) -> CABasicAnimation {
        ...
        animation.toValue = angle * .pi / 180.0
    ...
    func startAnimation() {
        ...
        dashOneLayer.transform = CATransform3DMakeRotation(-45 * .pi / 180.0, 0.0, 0.0, 1.0)
        dashTwoLayer.transform = CATransform3DMakeRotation(45 * .pi / 180.0, 0.0, 0.0, 1.0)
